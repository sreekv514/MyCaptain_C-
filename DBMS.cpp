// Student Database Management System using structure and files in C++
...
int main()
{
    ...
    while(1)
    {
        ...
        case '2':
            ...
            {
                cout<<"\n\n \t\t Name of student : "<<s.first_name<<setw(10)<<s.last_name;
                cout<<"\n \t\t Course and Year : "<<s.dummy<<s.course<<setw(10)<<", "<<s.year;
